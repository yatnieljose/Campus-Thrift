...
import Views.Components.Listing as Listing
from tkinter import *
...
class Feedback:
    ...
    def __init__(self, master):
        ...
        ttk.Label(self.frame_content, image=lion_photo).grid(
            row=2, column=1, padx=5, sticky='sw')
        ...
        for i in range(5):
            listing.Listing(self.frame_content,
                            "item name", "$99.99", 5 + i, 0)
